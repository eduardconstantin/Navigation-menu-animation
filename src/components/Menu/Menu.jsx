			...
			>
				<ul className={style.menuList}>
					<li>
						...
						>
							<motion.svg
								animate={isActive[0] ? 'open' : 'closed'}
								variants={menuContentSVG}
							...
							<motion.p initial='initial' animate={isActive[0] ? 'open' : 'closed'} variants={menuContentP}>
								HOME
							</motion.p>
						</motion.button>
					</li>
					<li>
						...
						>
							<motion.svg
								animate={isActive[1] ? 'open' : 'closed'}
								variants={menuContentSVG}
								xmlns='http://www.w3.org/2000/svg'
								fill='#5D606F'
								viewBox='0 0 16 16'
							...
							<motion.p initial='initial' animate={isActive[1] ? 'open' : 'closed'} variants={menuContentP}>
								NEWS
							</motion.p>
						</motion.button>
					</li>
					...
					<li>
						...
						>
							<motion.svg
								animate={isActive[2] ? 'open' : 'closed'}
								variants={menuContentSVG}
								xmlns='http://www.w3.org/2000/svg'
								fill='#5D606F'
								viewBox='0 0 16 16'
							...
							<motion.p initial='initial' animate={isActive[2] ? 'open' : 'closed'} variants={menuContentP}>
								STORE
							</motion.p>
						</motion.button>
					</li>
					<li>
						...
						>
							<motion.svg variants={menuContentSVG} xmlns='http://www.w3.org/2000/svg' fill='#5D606F' viewBox='0 0 16 16'>
							...
							<motion.p initial='initial' animate={isActive[3] ? 'open' : 'closed'} variants={menuContentP}>
								SETTINGS
							</motion.p>
						</motion.button>
					</li>
